...
class ConditionsControllerTest < ActionController::TestCase
  ...
  test "should create condition" do
    assert_difference('Condition.count') do
      post :create, condition: { description: @condition.description, final_value: @condition.final_value, initial_value: @condition.initial_value }
    end
  ...
  test "should update condition" do
    put :update, id: @condition, condition: { description: @condition.description, final_value: @condition.final_value, initial_value: @condition.initial_value }
    assert_redirected_to condition_path(assigns(:condition))
  end
