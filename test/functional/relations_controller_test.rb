...
class RelationsControllerTest < ActionController::TestCase
  ...
  test "should create relation" do
    assert_difference('Relation.count') do
      post :create, relation: { person_id: @relation.person_id, relationship_id: @relation.relationship_id, relative_id: @relation.relative_id }
    end
  ...
  test "should update relation" do
    put :update, id: @relation, relation: { person_id: @relation.person_id, relationship_id: @relation.relationship_id, relative_id: @relation.relative_id }
    assert_redirected_to relation_path(assigns(:relation))
  end
