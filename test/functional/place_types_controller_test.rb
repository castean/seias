...
class PlaceTypesControllerTest < ActionController::TestCase
  ...
  test "should create place_type" do
    assert_difference('PlaceType.count') do
      post :create, place_type: { description: @place_type.description, name: @place_type.name, nick: @place_type.nick }
    end
  ...
  test "should update place_type" do
    put :update, id: @place_type, place_type: { description: @place_type.description, name: @place_type.name, nick: @place_type.nick }
    assert_redirected_to place_type_path(assigns(:place_type))
  end
