...
class GruposControllerTest < ActionController::TestCase
  ...
  test "should create grupo" do
    assert_difference('Grupo.count') do
      post :create, grupo: { descripcion: @grupo.descripcion, nombre: @grupo.nombre, vulnerable: @grupo.vulnerable }
    end
  ...
  test "should update grupo" do
    put :update, id: @grupo, grupo: { descripcion: @grupo.descripcion, nombre: @grupo.nombre, vulnerable: @grupo.vulnerable }
    assert_redirected_to grupo_path(assigns(:grupo))
  end
