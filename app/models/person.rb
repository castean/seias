...
class Person < ActiveRecord::Base
  ...
  attr_accessible :name, :last_name, :second_last_name, :marital_status_id, :sex, :ethnic_group_id, :birthday, :born_town_id, :county_id, :county_id_2, :town_id, :address, :address_two,
                  ...
                  :diagnosis_description, :discapacity_origin_id, :discapacity_origin_year, :observations, :status_id, :funcional_support, :discapacity
  attr_accessor   :county_id, :county_id_2, :discapacity
end
